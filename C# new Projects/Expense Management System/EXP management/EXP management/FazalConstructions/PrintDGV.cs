...
namespace FazalConstructions
{
    class PrintDGV
    {
        ...
        public static string GrandExp = "";
        public static string RcvAmt = "";
        public static string blnc = "";
        public static string projectName = "";
        public static string afterComission = "";
                ...
                while (RowPos <= dgv.Rows.Count - 1)
                {
                    ...
                    else
                    {
                        if (NewPage)
                        {
                            ...
                            e.Graphics.DrawString(s, new Font(dgv.Font, FontStyle.Italic), 
                        ...
                        foreach (DataGridViewCell Cel in GridRow.Cells)
                        {
                            ...
                            else if (((Type) ColumnTypes[i]).Name == "DataGridViewComboBoxColumn")
                            {
                                ...
                                e.Graphics.DrawString(Cel.Value.ToString(), Cel.InheritedStyle.Font, 
                                        ...
                                        - 24, CellHeight), StrFormatComboBox);
                            }
                    ...
                    int RowsPerPage)
        {
            ...
            string contact = details.Tables[0].Rows[0]["AdditionalInfo"].ToString();

            e.Graphics.DrawString("Contact Complete Features Like Description, Total ETC", new Font("Arial", 20, FontStyle.Bold), Brushes.Black, new Point(350, 30));
            e.Graphics.DrawString("Construction Services", new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(320, 60));
            MainForm frm = new MainForm();
            e.Graphics.DrawString(frm.label5.Text, new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(100, 660));
            e.Graphics.DrawString("Narration", new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(300, 680));
            e.Graphics.DrawString(frm.label5.Text, new Font("Arial", 14, FontStyle.Regular), Brushes.Black, new Point(100, 700));

            
            

            e.Graphics.DrawString("------------------------------------------------------------------------------------------------------------------------------", new Font("Arial", 12, FontStyle.Regular), Brushes.Black, new Point(100, 1040));
        }
    }
}
