...
if( $firstname && $lastname && $email && $number && $comments){

echo "<center><h1>We Will Work on  According To Your Feedback</h1> </center>";
...
$var="insert into contactus(firstname,lastname,email,number,comments) values('$firstname','$lastname','$email','$number','$comments')";
mysql_query($var);
