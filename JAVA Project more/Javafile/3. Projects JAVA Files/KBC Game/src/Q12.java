...
public class Q12 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:12");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/twelve.png")));
        pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/11-15/quit11.jpg")));
    pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 12/1.png")));
    pan.add(jlb);
    this.setTitle("Question No:12");
    this.setContentPane(jlb);
    this.setResizable(false);
    this.pack();
    this.setVisible(true);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 12/2.png")));
    pan.add(jlb);
    this.setTitle("Question No:12");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 12/3.png"))); 
    pan.add(jlb);
    this.setTitle("Question No:12");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 12/4.png")));
    pan.add(jlb);
    this.setTitle("Question No:12");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 12/5.png")));
    pan.add(jlb);
    this.setTitle("Question No:12");
    this.setContentPane(jlb);
    this.setResizable(false);
