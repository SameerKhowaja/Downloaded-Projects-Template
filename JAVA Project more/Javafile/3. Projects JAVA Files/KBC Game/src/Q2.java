...
public class Q2 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        //Question
        question = new JLabel(" Which of the following is the smallest integer data type ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" Which of the following is not a primitive data type ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which value can not store character data type ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op10=new JButton("Special character");
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which of the following data types comes under floating data types ? ");
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" In order to fetch stream of data from network or file, following data type used ? ");
        question.setBounds(59,440,1000,60);
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" What is size of integer in java programming ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which data type can store  64 bit value ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Short data type has a minimum value of ________ ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op30=new JButton("-2,147,483,648");
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" How many byte will byte data type take in java ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Default value of “double” data type is ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
