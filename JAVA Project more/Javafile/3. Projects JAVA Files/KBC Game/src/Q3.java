...
public class Q3 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        //Question
        question = new JLabel(" String is an ________ ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" If s = \"text\", what is the value returned by s.length() ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which of these method of String class is used to obtain character at specified index ? ");
        question.setBounds(58,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 19));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op9=new JButton("char()");
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which of these method of String class can be used to test to strings for equality ? ");
        question.setBounds(29,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 19));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op13=new JButton("isequal()");
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" Which of these class is used to read characters in a file ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 3
        op23=new JButton("FileInputStream");
        ...
        //option 4
        op24=new JButton("InputStreamReader");
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which of these is a method to clear all the data present in output buffers ? ");
        question.setBounds(59,440,1000,60);
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Which of these interface is not a member of java.io package ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Which of these is specified by a File object ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 1
        op33=new JButton("a file in disk");
        ...
        //option 2
        op34=new JButton("directory in disk");
        ...
        //option 3
        op35=new JButton("directory path");
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Which of these class is not a member class of java.io package ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
