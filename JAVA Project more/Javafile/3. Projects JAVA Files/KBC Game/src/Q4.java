...
public class Q4 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:04");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/four.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" Which of these keywords is used to define interfaces in Java ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" Which of these can be used to fully abstract a class from its implementation ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which of these access specifiers can be used for an interface ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which of these keywords is used by a class to use an interface defined previously ? ");
        question.setBounds(59,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 19));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op13=new JButton("Import");
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" Which of the following package stores all the standard java classes ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 4
        op20=new JButton("java.packages");
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" Package of drawstring() method is ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which class provides many methods for graphics programming ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op26=new JButton("java.Graphics");
        ...
        //option 3
        op27=new JButton("java.awt.Graphics");
        ...
        //option 4
        op28=new JButton("None of the above");
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" What is the meaning of JIT ");
        question.setBounds(60,440,1000,60);
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Thread class is available in ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 30));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Interfaces helps in which type of inheritance ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 1
        op37=new JButton("Multiple inheritance");
        op37.setBounds(86,538,320,43);
        op37.setFont(new Font("Gill Sans", 5, 20));
        op37.setBackground(Color.BLACK);
        op37.setForeground(Color.WHITE);
        frm3.add(op37);
        
        //option 2
        op38=new JButton("Multilevel inheritance");
        op38.setBounds(86,610,320,43);
        op38.setFont(new Font("Gill Sans", 5, 20));
        op38.setBackground(Color.BLACK);
        op38.setForeground(Color.WHITE);
        frm3.add(op38);
        
        //option 3
        op39=new JButton("Hierarchical inheritance");
        op39.setBounds(551,538,320,43);
        op39.setFont(new Font("Gill Sans", 5, 20));
        ...
        op40.setFont(new Font("Gill Sans", 5, 20));
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect3.png"))); 
    pan.add(jlb);
