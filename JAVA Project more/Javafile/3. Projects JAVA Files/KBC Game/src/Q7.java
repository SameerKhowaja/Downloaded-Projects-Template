...
public class Q7 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:07");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/seven.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" Decrement operator, –, decreases value of variable by what number ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" Which operator is used to invert all the digits in binary representation of a number ? ");
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which of these is not a bit-wise operator ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which of the following can be operands of arithmetic operators ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" Which right shift operator preserves the sign of the value ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 24));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" Which of these have highest precedence ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which of these function is used to allocate memory to array variable in Java ? ");
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Which of these is a standard for communicating multimedia content over email ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 20));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Arrays in Java are implemented as ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Which of these methods is used to make raw MIME formatted string ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 24));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/6-10/quit6.jpg")));
    pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect6.png"))); 
    pan.add(jlb);
