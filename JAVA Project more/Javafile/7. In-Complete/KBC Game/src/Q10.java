...
public class Q10 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:10");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/ten.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" What is the limit of data to be passed from HTML when doGet() method is used ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" Which method is used to specify before any lines that uses the PrintWriter ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 22));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op6=new JButton("setContentType()");
        ...
        //option 3
        op7=new JButton("setContextType()");
        ...
        //option 4
        op8=new JButton("setResponseType()");
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which method is called first by an applet ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which method can be used to draw a rectangle in the a Applet ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" AppletViewer tool is available in which of the folder of JDK ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" The Applet class is in __________ package ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which of the following is an optional attribute of applet tag ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Which method can be used to draw a circle in the applet ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" To run an applet __________ command is used ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Which package contains color class ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op38=new JButton("java.graphics");
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/6-10/quit9.jpg")));
    pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect9.png"))); 
    pan.add(jlb);
