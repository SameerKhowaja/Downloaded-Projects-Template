...
public class Q16 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        //Question
        question = new JLabel(" Where does a computer add and compare data ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" The word \"Computer\" usually refers to the Central processing unit plus ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 1
        op5=new JButton("External memory");
        ...
        //option 2
        op6=new JButton("Internal memory");
        ...
        //option 4
        op8=new JButton("Output devices");
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which generation of computers is converted by the period 1964-1977 ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which of the following belongs to the first generation of computer ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" The part of machine level instruction, which tells the central processor what has to be done, is ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 1
        op17=new JButton("Operation code");
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" What hardware was used by first generation computer ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which can read data convert them to a form that computer can use ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Which of the following is still useful for adding numbers ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 27));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Which transmission media is fastest ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 1
        op33=new JButton("coaxial cable");
        ...
        //option 4
        op36=new JButton("infrared rays");
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Floppy disks, which are made from flexible plastic material, are also called ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 23));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op37=new JButton("Hard disks");
        ...
        //option 2
        op38=new JButton("High-density disks");
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect.png"))); 
    pan.add(jlb);
