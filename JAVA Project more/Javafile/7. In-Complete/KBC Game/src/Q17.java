...
public class Q17 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:02");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/two.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" Which of the following is not valid version of MS Office ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" What is the permanent memory built into your computer called ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" The pattern of printed lines on most products are called ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" How many megabytes make a gigabyte ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" Which of the following is not an example of hardware ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" ____________ is the process of carrying out commands ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" What kind of scheme is the http protocol ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op26=new JButton("store/forward");
        ...
        //option 3
        op27=new JButton("request/response");
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" A function inside another function is termed as ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 1
        op29=new JButton("round function");
        ...
        //option 3
        op31=new JButton("test function");
        ...
        //option 4
        op32=new JButton("nested function");
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Which of the followng is an example of optical disk ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 1
        op33=new JButton("Magnetic disk");
        ...
        //option 2
        op34=new JButton("Blue-ray disk");
        ...
        //option 3
        op35=new JButton("Data bus disk");
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" THE concept of logarithm was developed by ___________ ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 26));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 1
        op37=new JButton("Blaise Pascal");
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect1.png"))); 
    pan.add(jlb);
