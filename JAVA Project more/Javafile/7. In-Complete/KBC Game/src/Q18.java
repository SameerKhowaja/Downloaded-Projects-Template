...
public class Q18 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:03");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/three.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" Which company is the biggest player in the microprocessor industry ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" The secondary storage device that following the sequentional mode of access is ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" In LISP, the square root of X is referenced as ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Nils Nilsson headed a team at SRI that created a mobile robot named ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" In LISP, the function evaluates both and is ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" The field that investigates the mechanics of human intelligence is ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 23));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 2
        op22=new JButton("cognitive science");
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" ________ is the first available high-level language developed by IBM in 1957 ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 23));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q8(){
        ...
        question = new JLabel(" The secondary storage device that following the sequentional mode of access is ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 21));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op29=new JButton("Hard Disk");
        ...
        //option 4
        op32=new JButton("Magnetic Disk");
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" A sprit shape track formatting is present in ________ ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 26));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 3
        op35=new JButton("Magnetic Disk");
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Hard Disk is a kind of ____________ ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 3
        op39=new JButton("Magnetic Disk");
        ...
        //option 4
        op40=new JButton("Temproary Memory");
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect2.png"))); 
    pan.add(jlb);
