...
public class Q20 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:05");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/five.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" The JDBC-ODBC bridge is ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" Which type of driver provides JDBC access via one or more ODBC drivers ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" How many JDBC driver types does Sun define ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Which of the following reference types cannot be generic ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 26));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op13=new JButton("Collective class");
        ...
        //option 4
        op16=new JButton("Anonymous inner class");
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" Which of these types cannot be used to initiate a generic type ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 1
        op17=new JButton("Primitive Types");
        ...
        //option 2
        op18=new JButton("Integer class");
        ...
        //option 3
        op19=new JButton("Collections class");
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" Which of these instance cannot be created ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which of these data type cannot be type parameterized ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 27));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        
        //option 1
        op25=new JButton("Map");
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Which of these methods of httpd class is used to read data from the stream ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 4
        op32=new JButton("getRawRequest()");
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Which of these class is used for operating on request from the client to the server ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 3
        op35=new JButton("httpConnection");
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" In IPV 4, the IP address 200.200.200.200 belongs to ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect4.png"))); 
    pan.add(jlb);
