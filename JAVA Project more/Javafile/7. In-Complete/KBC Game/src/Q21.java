...
public class Q21 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:06");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/six.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" Which keyword is used to monitor statement for exception ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" To explicitly throw an exception , ______ keyword is used ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 27));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Exception is subclass of ____ class ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 2
        op10=new JButton("RuntimeException");
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" An Object Relational Mapping tool simplifies which of these ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" What is checked exception ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 1
        op17=new JButton("SQL Exception");
        ...
        //option 2
        op18=new JButton("Runtime Erroe");
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" Which of the following methods is overridden by Action class ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which of the java bean tags is used to show the bean value on the web page ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Hibernate is an ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 30));
        question.setForeground(Color.WHITE);
        frm3.add(question);
        ...
        //option 4
        op32=new JButton("All mentioned above");
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Which block gets executed compulsory whether exception is caught or not ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 26));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" How many layers are available in Hibernate architecture ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/6-10/quit5.jpg")));
    pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect5.png"))); 
    pan.add(jlb);
