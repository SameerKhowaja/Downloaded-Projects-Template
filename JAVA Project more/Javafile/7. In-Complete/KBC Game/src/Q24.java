...
public class Q24 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:09");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/nine.png")));
        pan.add(jlb);
        ...
        //Question
        question = new JLabel(" Which of these class is used to make a thread ? ");
    ...
    public void q2(){
        ...
        //Question
        question = new JLabel(" Which of these interface is implemented by Thread class ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 4
        op8=new JButton("MapConnections");
    ...
    public void q3(){
        ...
        //Question
        question = new JLabel(" Which of these packages contain all the Java’s built in exceptions ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q4(){
        ...
        //Question
        question = new JLabel(" Thread priority in Java is ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q5(){
        ...
        //Question
        question = new JLabel(" What is the name of the method used to start a thread execution ? ");
        question.setBounds(60,440,1000,60);
    ...
    public void q6(){
        ...
        //Question
        question = new JLabel(" What is the return type of a method that does not returns any value ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 25));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q7(){
        ...
        //Question
        question = new JLabel(" Which of the following is a method having same name as that of it’s class ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 24));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q8(){
        ...
        //Question
        question = new JLabel(" Which method can be defined only once in a program ? ");
        question.setBounds(60,440,1000,60);
        ...
        //option 1
        op29=new JButton("private method");
        ...
        //option 2
        op30=new JButton("finalize method");
        ...
        //option 3
        op31=new JButton("static method");
    ...
    public void q9(){
        ...
        //Question
        question = new JLabel(" Which of these keywords can be used to prevent inheritance of a class ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 24));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    public void q10(){
        ...
        //Question
        question = new JLabel(" Which of these method of Object class can clone an object ? ");
        question.setBounds(60,440,1000,60);
        question.setFont(new Font("Gill Sans", 15, 28));
        question.setForeground(Color.WHITE);
        frm3.add(question);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/6-10/quit8.jpg")));
    pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/incorrect/incorrect8.png"))); 
    pan.add(jlb);
