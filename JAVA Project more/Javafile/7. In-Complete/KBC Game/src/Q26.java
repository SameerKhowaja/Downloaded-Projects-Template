...
public class Q26 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 11/5.pngg")));
    pan.add(jlb);
    this.setTitle("Question No:11");
    this.setContentPane(jlb);
    this.setResizable(false);
