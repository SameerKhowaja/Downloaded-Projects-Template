...
public class Q28 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:13");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/thirteen.png")));
        pan.add(jlb);
    ...
    public void q5(){
        ...
        //option 1
        op17=new JButton("V:60;C:93;S:37");
        ...
        //option 2
        op18=new JButton("V:37;C:60;S:93");
        ...
        //option 3
        op19=new JButton("V:93;C:37;S:60");
        ...
        //option 4
        op20=new JButton("V:93;C:60;S:37");
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/11-15/quit12.jpg")));
    pan.add(jlb);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 13/1.png")));
    pan.add(jlb);
    this.setTitle("Question No:13");
    this.setContentPane(jlb);
    this.setResizable(false);
    this.pack();
    this.setVisible(true);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 13/2.png")));
    pan.add(jlb);
    this.setTitle("Question No:13");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 13/3.png"))); 
    pan.add(jlb);
    this.setTitle("Question No:13");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 13/4.png")));
    pan.add(jlb);
    this.setTitle("Question No:13");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 13/5.png")));
    pan.add(jlb);
    this.setTitle("Question No:13");
    this.setContentPane(jlb);
    this.setResizable(false);
