...
public class Q29 extends JFrame implements MouseListener, ActionListener{
    JFrame frm3;
    ...
    public void q1(){
        ...
        frm3.setLayout(null);
        frm3.setTitle("Question No:14");
        frm3.getContentPane().setBackground(Color.GREEN);
        
        //bacgrd
        JPanel pan = new JPanel();
        JLabel jlb = new JLabel();
        jlb.setIcon(new ImageIcon(getClass().getResource("questions/fourteen.png")));
        pan.add(jlb);
    ...
    public void q3(){
        ...
        //option 3
        op11=new JButton("Compilation fails");
    ...
    public void q4(){
        ...
        //option 2
        op14=new JButton("compilaton fails");
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/11-15/quit13.jpg")));
    pan.add(jlb);
    ...
    public void p1(){
    this.setBounds(300,20,40,40);
    //this.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 14/1.png")));
    pan.add(jlb);
    this.setTitle("Question No:14");
    this.setContentPane(jlb);
    this.setResizable(false);
    this.pack();
    this.setVisible(true);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 14/2.png")));
    pan.add(jlb);
    this.setTitle("Question No:14");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 14/3.png"))); 
    pan.add(jlb);
    this.setTitle("Question No:14");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 14/4.png")));
    pan.add(jlb);
    this.setTitle("Question No:14");
    this.setContentPane(jlb);
    this.setResizable(false);
    ...
    JPanel pan = new JPanel();
    JLabel jlb = new JLabel();
    jlb.setIcon(new ImageIcon(getClass().getResource("Wrong Answer/Quiz Answers/JAVA Quiz/Question 14/5.png")));
    pan.add(jlb);
    this.setTitle("Question No:14");
    this.setContentPane(jlb);
    this.setResizable(false);
