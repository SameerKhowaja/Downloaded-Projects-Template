...
<title>Project Discussion Forum</title>
        ...
        <div class="art-Sheet">
            ...
            <div class="art-Sheet-body">
                <div class="art-Header">
                    ...
                    <div class="art-Logo">
                        <h1 id="name-text" class="art-Logo-name"><a href="#">Project Discussion Forum</a></h1>
                        <div id="slogan-text" class="art-Logo-text">think it! code it. </div>
                    </div>
                </div>
                <div class="art-nav">
                	<div class="l"></div>
