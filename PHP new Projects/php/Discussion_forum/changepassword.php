...
<body background="ups/images456.jpg">
    <span class="style1">
<?php 
		$conn_db = mysql_connect('localhost','root','') or die();
		$sel_db = mysql_select_db('tech_forum',$conn_db) or die();
		...
		$pass=$_POST['e_mail'];
		$chg_pwd=mysql_query("select * from user where password='$old_pass' AND e_mail='$pass'");
		$chg_pwd1=mysql_fetch_array($chg_pwd);
		$data_pwd=$chg_pwd1['password'];
		if($data_pwd==$old_pass){
		if($new_pass==$re_pass){
			$update_pwd=mysql_query("update user set password='$new_pass' where e_mail='$pass'");
		...
		{
		echo "<script>alert('Your old password is wrong'); window.location='admin/home.php'</script>";
		}}
	?>
<form id="form1" name="form1" method="post" action="">
  <table width="1000" align="center" cellpadding="0" background="ups/Page-BgGlare.png">
    ...
    <tr>
      <td colspan="3" background="ups/IMG_3375.JPG" class="style1"><object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0" width="1000" height="200" align="middle">
