       ...
       /********************* Step 2 *****************************/
        ...
        <div id="container">
            ...
            <div class="menubar">
                ...
                <form name="admwelcome" action="deptwelcome.php" method="post">
                    <ul id="menu">
          ...
          <h4 style="color:#000000;text-align:center;margin:2px 3px 5px 5px;"><i> &nbsp;Welcome <?php echo htmlspecialchars_decode($r['role'], ENT_QUOTES);?>
          this is page is under construction...</i></h4>
