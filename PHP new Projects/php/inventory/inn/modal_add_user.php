    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
					...
					<form method="post" enctype="multipart/form-data" class="form-horizontal" style="margin-left:100px;">
					  ...
					  <div class="form-group">
						<label for="inputPassword3" class="col-sm-3 control-label">ACCESS LEVEL</label>
						<div class="col-sm-4">
						  <select name="access">
...
mysql_query("INSERT INTO history (date,action,data) VALUES (NOW(),'Add User','$user')")or die(mysql_error());
						...
						{
						mysql_query ("INSERT INTO user (firstname,middlename,lastname,username,password,user_added,access)
						 VALUES ('$firstname','$middlename','$lastname','$username','$password',NOW(),'$access')")or die(mysql_error());
						}
