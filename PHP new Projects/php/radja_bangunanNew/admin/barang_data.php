  ...
  <tr>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="50" bgcolor="#CCCCCC"><strong>Brands</strong></th>
        <th width="50" bgcolor="#CCCCCC"><strong>Model</strong></th>
        <th width="50" bgcolor="#CCCCCC"><strong>Dimension</strong></th>
        <th width="50" bgcolor="#CCCCCC"><strong>Released On</strong></th>
