...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-common">
  <tr>
    <td colspan="2" align="right"><h1><b>DATA KOTA DAN KABUPATEN </b></h1></td>
  </tr>
  ...
  <tr>
	...
	<table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
      <tr>
        ...
        <th width="20" bgcolor="#CCCCCC"><strong>Id Kab kot</strong></th>
        <th width="100" align="right" bgcolor="#CCCCCC"><strong> Nama Kota / kabupaten</strong></th>
	...
	?>
      <tr>
        ...
        <td align="right"><?php echo $myData['nama_kabkot']; ?></td>
