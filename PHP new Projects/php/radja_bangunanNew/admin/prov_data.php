...
<table width="800" border="0" cellpadding="2" cellspacing="1" class="table-common">
    <tr>
        <td colspan="2" align="right"><h1><b>DATA PROVINSI FOR PELANGGAN </b></h1></td>
    </tr>
        ...
        <td colspan="2">
            <table class="table-list" width="100%" border="0" cellspacing="1" cellpadding="2">
                <tr>
                    ...
                    <th width="88" align="center" bgcolor="#CCCCCC"><strong>Id Prov</strong></th>
                    <th width="20" bgcolor="#CCCCCC"><strong>Nama Provinsi</strong></th>
                ...
                while ($myData = mysql_fetch_array($myQry)) {
                    ...
                    <tr>
                        ...
                        <td width="44" align="center"><a href="?open=Prov-Edit&Kode=<?php echo $Kode; ?>" target="_self" alt="Edit Data">Edit</a></td>
                        <td width="42" align="center"><a href="?open=Prov-Delete&Kode=<?php echo $Kode; ?>" target="_self" alt="Delete Data" onclick="return confirm('ANDA YAKIN AKAN MENGHAPUS DATA  NAMA PROVINSI INI ... ?')">Delete</a></td>
                    </tr>
                <?php } ?>
            </table></td>
    </tr>
