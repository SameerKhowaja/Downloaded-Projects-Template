...
?>
		<div class="row">	  
			...
			<h3>Rp.<?php echo format_angka($barangData['harga_jual']); ?></h3>
			<br/>
			  <a href="?open=Barang-Beli&Kode=<?php echo $KodeBarang; ?>" class="btn btn-primary btn-large"><i class=" icon-shopping-cart"></i> Add to cart</a>
			  <a href="?open=Barang-Lihat&Kode=<?php echo $KodeBarang; ?>" class="btn btn-large">VIEW</a>
				</form>
			</div>
	</div>
	<hr class="soft"/>
