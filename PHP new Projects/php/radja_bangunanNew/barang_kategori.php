...
?>
		<div class="row">	  
			...
			<h3>Rp.<?php echo format_angka($barang2Data['harga_jual']); ?></h3>
			
			  <a href="?open=Barang-Beli&Kode=<?php echo $KodeBarang; ?>" class="btn btn-large"><i class=" icon-shopping-cart"></i> Add to cart</a>
