...
if (isset($_GET['Kode'])) {
	...
	$lihatQry= mysql_query($lihatSql, $koneksidb) or die("Data Gagal Ditampilkan".mysql_error());
	$no=0;
...
<!-- ==================================================Header End====================================================================== -->
	...
	<div class="row">
			...
			<div class="span6">
				...
				<small><strong>Category : <?php echo $lihatData['nm_kategori']; ?></strong></small>
				<hr class="soft"/>
				<form class="form-horizontal qtyFrm">
				  <div class="control-group">
					<label class="control-label"><span> Rp.<?php echo format_angka($lihatData['harga_jual']); ?></span></label>
					<div class="controls">
					<!--<input type="number" class="span1" placeholder="Qty."/>--->
					  <a href="?open=Barang-Beli&Kode=<?php echo $KodeBarang; ?>" class="btn btn-primary btn-large pull-right"><i class=" icon-shopping-cart"></i> Beli</a>
					</div>
				  </div>
				</form>

				<hr class="soft"/>
				<h4><font color="red"><?php echo $lihatData['stok']; ?></font> items in stock</h4>
            ...
            <div id="myTabContent" class="tab-content">
			  ...
			  <h4>Product Information</h4>
				...
				<tbody>
				<tr class="techSpecRow" bgcolor="#998706"><th colspan="2">Product Details</th></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Brand: </td><td class="techSpecTD2"><?php echo $lihatData['brand']; ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Model:</td><td class="techSpecTD2"><?php echo $lihatData['model']; ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Released on:</td><td class="techSpecTD2"> <?php echo $lihatData['realeased']; ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Dimensions:</td><td class="techSpecTD2"> <?php echo $lihatData['dimension']; ?></td></tr>
				<tr class="techSpecRow"><td class="techSpecTD1">Display size:</td><td class="techSpecTD2"><?php echo $lihatData['display']; ?></td></tr>
				</tbody>
				</table>
