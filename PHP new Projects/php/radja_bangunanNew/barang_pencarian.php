...
?>
  <tr>
    <td width="24%" align="center">
		...
		<a href="?open=Barang-Beli&Kode=<?php echo $KodeBarang; ?>" class="btn btn-small"><i class=" icon-shopping-cart"></i> Add to cart</a>
	...
	<strong>Kategori :</strong> <?php echo $barang2Data['nm_kategori']; ?>	</td>
  </tr>
<?php } ?>
  <tr>
