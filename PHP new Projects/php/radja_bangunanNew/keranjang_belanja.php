...
<!-- ==================================================Header End====================================================================== -->
	...
	<img src="images/keranjang_belanja.gif" width="186" height="41">
	<hr class="soft"/>
	...
	?>
              ...
              <tbody>
                <tr>
                  ...
                  <td><a href="?open=KeranjangBelanja&aksi=Hapus&idHapus=<?php echo $myData['id']; ?>"><img src="images/hapus.gif" alt="Hapus Data Belanja ini" width="16" height="16" border="0"></a></td>
                </tr>

                <?php } ?>
				 <tr>
                  <td colspan="4" align="right"><strong> GRAND TOTAL</strong></td>
                  <td class="label label-important" colspan="2"> <strong><?php echo "Rp.".format_angka($grandTotal); ?> </strong></td>
                </tr>
                    <tr>
                            <td colspan="4">&nbsp;</td>
                            <td><input name="btnSimpan" type="submit" value="Lihat Total"></td>
                    </tr>
	</tbody>
	</form>
            </table>
        
	<a href="?open=Transaksi-Proses" class="btn btn-large pull-right">Next <i class="icon-arrow-right"></i></a><br><BR>
<a href="?open=Barang2" class="btn btn-large pull-right"><i class="icon-arrow-left"></i> Continue Shopping </a> <br /><BR>
        
			<table class="table table-bordered">
			<tbody>
                <tr><th colspan="2"><strong>KETERANGAN</strong> </th></tr>
                 <tr>
				 <td>
					<form class="form-horizontal">
		
					  <div class="control-group">
						<label class="span2 control-label" for="inputPost"><input name="" type="button" value="Lihat Total"></label>
						<div class="controls">
						  <b>klik tombol (gambar box Lihat Total) untuk melihat jumlah  yang harus dibayarkan sesuai kuantitas yang sudah diperbarui</b>
						</div>
					  </div>
                        <!---
					  <div class="control-group">
