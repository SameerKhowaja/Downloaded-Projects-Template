...
if(isset($_POST['btnLogin'])){
	...
	if($loginQty < 1) {
		$pesanError[] = "Data <b>Username dan Password</b> yang Anda masukan belum benar atau username adalah belum diaktivasi <b>Silahkan Aktivasi Username Anda Di Email Anda</b> ";
	}
