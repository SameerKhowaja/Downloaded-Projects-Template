...
<body>
    <div class="row-fluid">
        <div class="span9">
            <table width="100%" class="table table-bordered" border="1" cellpadding="0" cellspacing="3">
                <thead>
                    <tr>
                        <th height="22" colspan="8" bgcolor="#CCCCCC"><b>DAFTAR PEMESANAN</b></th>
                    </tr>
                    <tr bgcolor="#dfe9ff">
                        <th width="4" align="center" bgcolor="#F5F5F5"><strong>No</strong></th>
                        <th width="13%" bgcolor="#F5F5F5"><strong>No Pesan</strong></th>
                        <th width="14%" bgcolor="#F5F5F5"><strong>Tanggal</strong></th>
                        <th width="24%" bgcolor="#F5F5F5"><strong>Nama Penerima</strong></th>
                        <th width="14%" align="right" bgcolor="#F5F5F5"><strong>Total</strong></th>
                        <th width="23%" align="center" bgcolor="#F5f5f5"><strong>Biaya Kirim (Rp)</strong></th>
                        <th width="4%" align="center" bgcolor="#f5f5f5"><strong>Status</strong></th>
                        <th width="4%" align="center" bgcolor="#F5F5F5"><strong>Tools</strong></th>
                    </tr>
                    <?php
                   // Deklrasi variabel
    $biayaKirim = 0;
    ...
    $unikTransfer = substr($totalBayar,0,-2).$digitHp;
      ...
      <td align="center" bgcolor="#FFFFCC"><?php echo $myData['status_bayar']; ?></td>
                        <td align="center"><a href="?open=TransaksiDetail&Kode=<?php echo  $Kode; ?>" target="_self"><font color="red">lihat</font></a><b>|</b><a href="?open=KonfirmasiPembayaran&Kode=<?php echo $Kode; ?>" target="_self"><font color="blue">confirm</font></a></td>
