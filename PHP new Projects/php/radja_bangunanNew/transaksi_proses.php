    ...
    <div class="page-header">
        ...
        <div class="row-fluid">
            <div class="span9">
                <table class="table table-striped" >
                        <thead>
                            <tr>
                                <th colspan="5" bgcolor="#a9a9a9"><strong>Konfirmasi Belanja</strong></th>
                            </tr>
                        </thead>
                    <tbody>
                    <tr>
                        ...
                        <td align="right"><strong>Total (Rp).</strong></td>
                    </tr>
                    </tbody>
     ...
     <div class="alert alert-block alert-info fade in">
        ...
        <table class="table table-striped table-bordered">
            <tbody>
                <tr>
                    <th colspan="2">ALAMAT TUJUAN PEGIRIMAN BARANG</th>
                </tr>
                <td width="200">
                    <label class="control-label" for="inputNama">Nama Penerima</label>
                    </td>
                    <td>
                    <div class="controls">
                        <input class="span6" name="txtNama" id="inputNama" type="text" placeholder="Nama Lengkap" value="<?php echo $hsl_plg['nm_pelanggan']; ?>">
                    </div>
                    </td>
                    </tr>
            <tr>
                <td>
                    <label class="control-label" for="inputTelepon">No. Telepon</label>
                </td>
                <td><div class="controls">
                    <input class="span6" name="txtNotelpon" id="inputTelepon" type="text" placeholder="No Telepon" value="<?php echo $hsl_plg['no_telepon']; ?>">
                </div></td>
            </tr>
             <tr>
                <td>
                    ...
                    <td>
                    <div class="controls">
                        <input class="span6" name="txtAlamat" type="text" id="inputAlamat" placeholder="Alamat" value="<?php echo $hsl_plg['alamat']; ?>">
                    </div>
               </td>
               </tr> 
            <tr>
                <td><label class="control-label">KodePos</label></td>
                <td><div class="controls">
                    <input class="span3" name="txtKodePos" type="text" id="inputKodePos" placeholder="KodePos" value="<?php echo $hsl_plg['kode_pos']; ?>">
                </div></td>
            </tr>
            <tr>
                <td><label class="control-label">Email</label></td>
                <td><div class="controls">
                    <input class="span5" name="txtEmail" type="text" id="inputEmail" placeholder="Email" value="<?php echo $hsl_plg['email']; ?>">
                </div></td>
            </tr>
            <tr>
                <td><label class="control-label">Method Of Payment</label></td>
                <td><div class="controls">
                    <select type="text" id="methodpayment" name="cmbPayment">
                        <option value="BLANK">-Pilih Metode Pembayaran- </option>
                        <option>Bank Transfer</option>
                        <option>Kartu Kredit</option>
                    </select><font color="Red"> <b>Silahkan Pilih Metode Pembayaran</b></font>
                </div></td>
            </tr>
            <tr>
            ...
            <tr>
                <td><div>
                    <label class="control-label" for="kecamatan">Kecamatan<sup>*</sup></label>
                </div></td>
                <td>
                    <div class="controls">
        ...
        <input class="btn btn-large pull-right" name="btnSimpan" type="submit" value="Transfer Bank"> 
        </form>       
           <div>
        <form method="post" action="<?php echo "check_out2.php";?>">
            <input name="txtNamaH" type="hidden" value="<?php echo $dataNamaH; ?>">
            <input name="txtAlamatH" type="hidden" value="<?php echo $dataAlamatH; ?>">
            <input name="txtKodePosH" type="hidden" value="<?php echo $dataKodePos; ?>">
            <button class="btn btn-large" name="pay" type="submit"><i class="icon-arrow-left" id="payment-form"></i> Kartu Kredit/VISA - Mastercard</button>
        </form>
        </div>
        <hr>
<br><br>
        ...
        <thead>
          <tr>
            ...
            <tr> <th colspan="3">Untuk memberikan kemudahan berbelanja online bersama kami, kami menawarkan beberapa metode pembayaran:</th> </tr>
        </thead>
        <tbody>
          <tr>
          ...
          <tr>
              <td>&nbsp;</td>
              <td align="center" valign="top">*</td>
              <td colspan="2">•	Batas pembayaran maksimal adalah  7x24 jam (7 hari) dari waktu pemesanan, melalui metode pembayaran di  atas.</td>
          </tr>
         <tr>
              <td>&nbsp;</td>
              <td>*</td>
