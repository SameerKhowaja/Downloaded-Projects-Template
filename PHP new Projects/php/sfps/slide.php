  ...
  <div class="books_stat">
	...
	<ul>
		<?php 
		$counter = 0;
		$stat = mysql_query("SELECT * FROM accounts where Account_Number != 'Archive' GROUP BY id ASC LIMIT 10") or die(mysql_error());
		WHILE($stats = mysql_fetch_array($stat)){
		$counter++;
		?>
		<li class="ctag tag<?php echo $counter; ?>" id="<?php echo $counter; ?>"><a href="#"><?php echo $stats['Bank_Name']; ?></a></li>
		<?php } ?>
	</ul>
