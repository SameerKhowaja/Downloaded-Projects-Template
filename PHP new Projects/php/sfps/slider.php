    ...
    <div id="slider1_container" style="position: relative; width: 475px;
        ...
        <div u="slides" style="cursor: move; position: absolute; border-radius:5px; border:1px solid #aaa; left: 0px; top: 0px; width: 600px; height: 300px;
			...
			<div>
                ...
                <div u="thumb" style="">Where We Begun. </div>
                <div u="caption" t="L" style="position: absolute; top: 20px; left: 20px; width: 200px; height: 30px; color: #ffffff; font-size: 20px; line-height: 30px;">The Old was bulky due to paper work</div>
            ...
            <div>
                ...
                <div u="thumb">St. Lukes Field</div>
                <div u="caption" t="MCLIP|L" style="position: absolute; top: 105px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">You need excellence?</div>
                <div u="caption" t="LISTH|L" style="position: absolute; top: 165px; left: 100px; width: 400px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;"> This the place to be.</div>
            </div>
                       
            <div>
                <img u=image src="images/2.jpg" />
                <div u="thumb">St. Lukes Admininstration Block</div>
                <div u="caption" t="DDG|TR" style="position: absolute; top: 135px; left: 100px; width: 150px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">St. Lukes</div>
                <div u="caption" t="DODGEDANCE|L" style="position: absolute; top: 135px; left: 300px; width: 250px; height: 30px; color: #ffffff; font-size: 26px; line-height: 30px; text-align: center;">Admininstration Block</div>
            </div>
