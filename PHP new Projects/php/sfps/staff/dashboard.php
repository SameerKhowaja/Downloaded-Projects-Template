...
<div id="page-wrapper">
        <?php 
	     $student = mysql_query("select * from student ")or die(mysql_error());
		...
		<?php 
	     $new = mysql_query("select * from student")or die(mysql_error());
...
<div id="page-wrapper">
		<?php 
	     $log = mysql_query("select * From fees")or die(mysql_error());
