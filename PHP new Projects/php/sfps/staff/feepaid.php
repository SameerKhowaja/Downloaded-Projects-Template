  ...
  <div class="row-fluid"> 
     <div class="empty">
	     <div class="pull-right">
		   <a href="print_feepaid.php" class="btn btn-info" id="print" data-placement="left" title="Click to Print"><i class="icon-print icon-large"></i> Print List</a> 		      
		   <script type="text/javascript">
		     $(document).ready(function(){
		     $('#print').tooltip('show');
		     $('#print').tooltip('hide');
...
<!-----------------------------------Content------------------------------------>
<?php
		$student_query = mysql_query("SELECT student.Name,student.username,student.Form,fees.bank_name,fees.fee_paid,fees.time
FROM student  LEFT OUTER JOIN fees ON student.username = fees.regno WHERE fees.fee_id !='' ")or die(mysql_error());
