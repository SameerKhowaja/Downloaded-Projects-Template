...
font-family:"Times New Roman","serif"'>STUDENT FEES PAYMENT SYSTEM</span></b></p>
...
<div class="pull-right">
   <div class="empty">
		   ...
		   <script type="text/javascript">
            ...
            normal'><span style='font-size:12.0pt;mso-bidi-font-size:11.0pt;font-family:
           "Times New Roman","serif"'>
			<a id="return" data-placement="top" class="btn btn-success" title="Click to Return" href="balances.php"><i class="icon-arrow-left"></i> Back</a></p>		
			<script type="text/javascript">
			$(document).ready(function(){
			$('#return').tooltip('show');
			$('#return').tooltip('hide');
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0
 ...
 <td width=188 style='width:140.9pt;border:solid windowtext 1.0pt;mso-border-alt:
  ...
  mso-background-themeshade:191;padding:0in 5.4pt 0in 5.4pt;height:23.25pt'>
  <p class=MsoNormal style='margin-bottom:0in;margin-bottom:.0001pt;line-height:
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Student Name<o:p></o:p></span></b></p>
  </td>
  ...
  normal'><b style='mso-bidi-font-weight:normal'><span style='font-family:"Times New Roman","serif"'>Date & Time <o:p></o:p></span></b></p>
   ...
   <!-- MYSQL FETCH ARRAY-->
<?php
		$student_query =  mysql_query("SELECT  student.username,student.Name,fees.balance,fees.time
